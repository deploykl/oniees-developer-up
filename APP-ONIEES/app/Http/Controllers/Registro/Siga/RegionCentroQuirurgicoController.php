...
use App\Exports\Excel\CentroQuirurgico\RegionCentroQuirurgicoExport;

class RegionCentroQuirurgicoController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.region.centro-quirurgico.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new RegionCentroQuirurgicoExport($codigo, $search, $ejecutora))->download('Centro Quirurgico.xlsx');
    }
}

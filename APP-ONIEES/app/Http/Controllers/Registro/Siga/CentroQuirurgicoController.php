...
use App\Exports\Excel\CentroQuirurgico\CentroQuirurgicoExport;

class CentroQuirurgicoController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.centro-quirurgico.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new CentroQuirurgicoExport($codigo, $search, $ejecutora))->download('Centro Quirurgico.xlsx');
    }
}

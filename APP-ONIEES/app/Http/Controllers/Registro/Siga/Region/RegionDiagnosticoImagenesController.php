...
use App\Exports\Excel\DiagnosticoImagenes\DiagnosticoImagenesExport;

class RegionDiagnosticoImagenesController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.diagnostico-imagenes.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new DiagnosticoImagenesExport($codigo, $search, $ejecutora))->download(' Diagnostico x Imagenes.xlsx');
    }
}

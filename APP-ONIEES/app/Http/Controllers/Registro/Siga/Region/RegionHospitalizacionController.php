...
use App\Exports\Excel\Hospitalizacion\HospitalizacionExport;

class RegionHospitalizacionController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.hospitalizacion.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new HospitalizacionExport($codigo, $search, $ejecutora))->download('Hopitalizacion.xlsx');
    }
}

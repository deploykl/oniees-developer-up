...
use App\Exports\Excel\CuidadosIntensivos\CuidadosIntensivosExport;

class RegionCuidadosIntensivosController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.cuidados-intensivos.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new CuidadosIntensivosExport($codigo, $search, $ejecutora))->download('Cuidados Intensivos.xlsx');
    }
}

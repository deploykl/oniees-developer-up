...
use App\Exports\Excel\Almacen\AlmacenExport;

class RegionAlmacenController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.almacen.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new AlmacenExport($codigo, $search, $ejecutora))->download('Almacen.xlsx');
    }
}

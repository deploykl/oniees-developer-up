...
use App\Exports\Excel\Emergencia\EmergenciaExport;

class RegionEmergenciaController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.emergencia.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new EmergenciaExport($codigo, $search, $ejecutora))->download('Emergencia.xlsx');
    }
}

...
use App\Exports\Excel\ConsultaExterna\ConsultaExternaExport;

class RegionConsultaExternaController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.consulta-externa.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new ConsultaExternaExport($codigo, $search, $ejecutora))->download('Consulta Externa.xlsx');
    }
}

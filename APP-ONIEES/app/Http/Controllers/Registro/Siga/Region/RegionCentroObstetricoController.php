...
use App\Exports\Excel\CentroObstetrico\CentroObstetricoExport;

class RegionCentroObstetricoController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.centro-obstetrico.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new CentroObstetricoExport($codigo, $search, $ejecutora))->download('Centro Obstetrico.xlsx');
    }
}

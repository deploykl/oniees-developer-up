...
use App\Exports\Excel\PatologiaClinica\PatologiaClinicaExport;

class PatologiaClinicaController extends Controller
{
    ...
    public function index() {
        return view('registro.siga.patologia-clinica.index');
    }
    ...
    public function export($codigo = "-", $search = "-", $ejecutora = "-") {
        ...
        return (new PatologiaClinicaExport($codigo, $search, $ejecutora))->download('Patologia Clinica.xlsx');
    }
}

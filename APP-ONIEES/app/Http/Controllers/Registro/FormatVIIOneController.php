...
use App\Models\FormatVIIOne;
use App\Models\Establishment;
use Illuminate\Support\Facades\Auth;

class FormatVIIOneController extends Controller
{
    ...
    public function delete(Request $request) {
        try {
            $formatDetail = FormatVIIOne::find($request->input("format_id"));
            $formatDetail->delete();
            return [
                'status' => 'OK',
    ...
    public function edit($id) {
        $formatDetail = FormatVIIOne::find($id);
        return $formatDetail;
    }
    
    public function updated(Request $request) {
        try {
            $formatDetail = FormatVIIOne::find($request->input('id'));
            $formatDetail->upss = $request->input('upss');
            $formatDetail->ambiente = $request->input('ambiente');
            $formatDetail->atenciones_juniors = $request->input('atenciones_juniors');
            $formatDetail->atenciones_adolescentes = $request->input('atenciones_adolescentes');

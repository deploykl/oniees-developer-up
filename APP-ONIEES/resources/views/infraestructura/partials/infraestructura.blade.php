        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input type="number" name="t_estacionamiento" value="{{ $infraestructura->t_estacionamiento ?? '' }}"
                    class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500" placeholder="0">
            </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div id="sec-acabados-exteriores" class="form-section" x-data="sectionCounter('sec-acabados-exteriores', 10)" x-init="init()">
        ...
        <div class="section-content" :class="open ? '' : 'hidden'">
            <div class="p-4">
                <!-- Grid de 2 columnas para los 5 elementos -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">

                    <!-- PISOS -->
                    <div class="border border-gray-100 rounded-lg p-4 bg-gray-50/30 hover:bg-gray-50 transition">
                        <h4
                            class="text-sm font-semibold text-gray-800 mb-3 border-l-3 border-teal-600 pl-2 flex items-center gap-2">
                            <i class="fas fa-square text-teal-600 text-xs"></i> PISOS
                        </h4>
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Material
                                    Predominante</label>
                                <div class="grid grid-cols-2 gap-1 text-sm">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="PMP" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'PMP' ? 'checked' : '' }}><span
                                            class="text-xs">Parquet/madera pulida</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="LAV" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'LAV' ? 'checked' : '' }}><span
                                            class="text-xs">Láminas asfálticas</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="LTC" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'LTC' ? 'checked' : '' }}><span
                                            class="text-xs">Loseta/terrazos</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="MAD" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'MAD' ? 'checked' : '' }}><span
                                            class="text-xs">Madera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="CEM" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'CEM' ? 'checked' : '' }}><span
                                            class="text-xs">Cemento</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="TIE" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'TIE' ? 'checked' : '' }}><span
                                            class="text-xs">Tierra</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pavimentos"
                                            value="OTR" class="text-teal-600"
                                            {{ ($infraestructura->ae_pavimentos ?? '') == 'OTR' ? 'checked' : '' }}><span
                                            class="text-xs">Otros</span></label>
                                </div>
                                <input type="text" name="ae_pavimentos_nombre"
                                    value="{{ $infraestructura->ae_pavimentos_nombre ?? '' }}"
                                    class="w-full mt-2 text-sm rounded-lg border-gray-200"
                                    placeholder="Especifique..."
                                    style="display: {{ ($infraestructura->ae_pavimentos ?? '') == 'OTR' ? 'block' : 'none' }}">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Estado Conservación</label>
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pav_estado"
                                            value="B" class="text-teal-600"
                                            {{ ($infraestructura->ae_pav_estado ?? '') == 'B' ? 'checked' : '' }}><span
                                            class="text-sm">Bueno (B)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pav_estado"
                                            value="R" class="text-teal-600"
                                            {{ ($infraestructura->ae_pav_estado ?? '') == 'R' ? 'checked' : '' }}><span
                                            class="text-sm">Regular (R)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_pav_estado"
                                            value="M" class="text-teal-600"
                                            {{ ($infraestructura->ae_pav_estado ?? '') == 'M' ? 'checked' : '' }}><span
                                            class="text-sm">Malo (M)</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-100 rounded-lg p-4 bg-gray-50/30 hover:bg-gray-50 transition">
                        <h4
                            class="text-sm font-semibold text-gray-800 mb-3 border-l-3 border-teal-600 pl-2 flex items-center gap-2">
                            <i class="fas fa-square text-teal-600 text-xs"></i> VEREDAS
                        </h4>
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Material
                                    Predominante</label>
                                <div class="grid grid-cols-2 gap-1 text-sm">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_veredas"
                                            value="LTC" class="text-teal-600"
                                            {{ ($infraestructura->ae_veredas ?? '') == 'LTC' ? 'checked' : '' }}><span
                                            class="text-xs">Loseta/terrazos</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_veredas"
                                            value="MAD" class="text-teal-600"
                                            {{ ($infraestructura->ae_veredas ?? '') == 'MAD' ? 'checked' : '' }}><span
                                            class="text-xs">Madera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_veredas"
                                            value="CEM" class="text-teal-600"
                                            {{ ($infraestructura->ae_veredas ?? '') == 'CEM' ? 'checked' : '' }}><span
                                            class="text-xs">Cemento</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_veredas"
                                            value="TIE" class="text-teal-600"
                                            {{ ($infraestructura->ae_veredas ?? '') == 'TIE' ? 'checked' : '' }}><span
                                            class="text-xs">Tierra</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_veredas"
                                            value="OTR" class="text-teal-600"
                                            {{ ($infraestructura->ae_veredas ?? '') == 'OTR' ? 'checked' : '' }}><span
                                            class="text-xs">Otros</span></label>
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Estado Conservación</label>
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_ver_estado"
                                            value="B" class="text-teal-600"
                                            {{ ($infraestructura->ae_ver_estado ?? '') == 'B' ? 'checked' : '' }}><span
                                            class="text-sm">Bueno (B)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_ver_estado"
                                            value="R" class="text-teal-600"
                                            {{ ($infraestructura->ae_ver_estado ?? '') == 'R' ? 'checked' : '' }}><span
                                            class="text-sm">Regular (R)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_ver_estado"
                                            value="M" class="text-teal-600"
                                            {{ ($infraestructura->ae_ver_estado ?? '') == 'M' ? 'checked' : '' }}><span
                                            class="text-sm">Malo (M)</span></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border border-gray-100 rounded-lg p-4 bg-gray-50/30 hover:bg-gray-50 transition">
                        <h4
                            class="text-sm font-semibold text-gray-800 mb-3 border-l-3 border-teal-600 pl-2 flex items-center gap-2">
                            <i class="fas fa-square text-teal-600 text-xs"></i> ZÓCALOS
                        </h4>
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Material
                                ...
                                <div class="flex flex-wrap gap-3 text-sm">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zocalos"
                                            value="LTC" class="text-teal-600"
                                            {{ ($infraestructura->ae_zocalos ?? '') == 'LTC' ? 'checked' : '' }}><span
                                            class="text-xs">Loseta/terrazos</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zocalos"
                                            value="CEM" class="text-teal-600"
                                            {{ ($infraestructura->ae_zocalos ?? '') == 'CEM' ? 'checked' : '' }}><span
                                            class="text-xs">Cemento</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zocalos"
                                            value="OTR" class="text-teal-600"
                                            {{ ($infraestructura->ae_zocalos ?? '') == 'OTR' ? 'checked' : '' }}><span
                                            class="text-xs">Otros</span></label>
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Estado Conservación</label>
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zoc_estado"
                                            value="B" class="text-teal-600"
                                            {{ ($infraestructura->ae_zoc_estado ?? '') == 'B' ? 'checked' : '' }}><span
                                            class="text-sm">Bueno (B)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zoc_estado"
                                            value="R" class="text-teal-600"
                                            {{ ($infraestructura->ae_zoc_estado ?? '') == 'R' ? 'checked' : '' }}><span
                                            class="text-sm">Regular (R)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_zoc_estado"
                                            value="M" class="text-teal-600"
                                            {{ ($infraestructura->ae_zoc_estado ?? '') == 'M' ? 'checked' : '' }}><span
                                            class="text-sm">Malo (M)</span></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border border-gray-100 rounded-lg p-4 bg-gray-50/30 hover:bg-gray-50 transition">
                        <h4
                            class="text-sm font-semibold text-gray-800 mb-3 border-l-3 border-teal-600 pl-2 flex items-center gap-2">
                            <i class="fas fa-square text-teal-600 text-xs"></i> MUROS
                        </h4>
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Material
                                    Predominante</label>
                                <div class="grid grid-cols-2 gap-1 text-sm">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="LBC" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'LBC' ? 'checked' : '' }}><span
                                            class="text-xs">Ladrillo/bloque</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="PSC" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'PSC' ? 'checked' : '' }}><span
                                            class="text-xs">Piedra/Sillar</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="ADO" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'ADO' ? 'checked' : '' }}><span
                                            class="text-xs">Adobe</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="TAP" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'TAP' ? 'checked' : '' }}><span
                                            class="text-xs">Tapia</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="MAD" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'MAD' ? 'checked' : '' }}><span
                                            class="text-xs">Madera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_muros"
                                            value="OTR" class="text-teal-600"
                                            {{ ($infraestructura->ae_muros ?? '') == 'OTR' ? 'checked' : '' }}><span
                                            class="text-xs">Otros</span></label>
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Estado Conservación</label>
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_mur_estado"
                                            value="B" class="text-teal-600"
                                            {{ ($infraestructura->ae_mur_estado ?? '') == 'B' ? 'checked' : '' }}><span
                                            class="text-sm">Bueno (B)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_mur_estado"
                                            value="R" class="text-teal-600"
                                            {{ ($infraestructura->ae_mur_estado ?? '') == 'R' ? 'checked' : '' }}><span
                                            class="text-sm">Regular (R)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_mur_estado"
                                            value="M" class="text-teal-600"
                                            {{ ($infraestructura->ae_mur_estado ?? '') == 'M' ? 'checked' : '' }}><span
                                            class="text-sm">Malo (M)</span></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- TECHO -->
                    <div
                        class="border border-gray-100 rounded-lg p-4 bg-gray-50/30 hover:bg-gray-50 transition lg:col-span-2">
                        <h4
                            class="text-sm font-semibold text-gray-800 mb-3 border-l-3 border-teal-600 pl-2 flex items-center gap-2">
                            <i class="fas fa-square text-teal-600 text-xs"></i> TECHO
                        </h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Material
                                    Predominante</label>
                                <div class="grid grid-cols-2 gap-1 text-sm">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="CA" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'CA' ? 'checked' : '' }}><span
                                            class="text-xs">Concreto armado</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="MAD" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'MAD' ? 'checked' : '' }}><span
                                            class="text-xs">Madera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="TEJ" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'TEJ' ? 'checked' : '' }}><span
                                            class="text-xs">Tejas</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="PCF" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'PCF' ? 'checked' : '' }}><span
                                            class="text-xs">Calamina/Fibra</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="CEB" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'CEB' ? 'checked' : '' }}><span
                                            class="text-xs">Caña/estera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="TEC" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'TEC' ? 'checked' : '' }}><span
                                            class="text-xs">Triplay/estera</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_techo"
                                            value="OTR" class="text-teal-600"
                                            {{ ($infraestructura->ae_techo ?? '') == 'OTR' ? 'checked' : '' }}><span
                                            class="text-xs">Otros</span></label>
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Estado Conservación</label>
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_tec_estado"
                                            value="B" class="text-teal-600"
                                            {{ ($infraestructura->ae_tec_estado ?? '') == 'B' ? 'checked' : '' }}><span
                                            class="text-sm">Bueno (B)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_tec_estado"
                                            value="R" class="text-teal-600"
                                            {{ ($infraestructura->ae_tec_estado ?? '') == 'R' ? 'checked' : '' }}><span
                                            class="text-sm">Regular (R)</span></label>
                                    <label class="flex items-center gap-1"><input type="radio" name="ae_tec_estado"
                                            value="M" class="text-teal-600"
                                            {{ ($infraestructura->ae_tec_estado ?? '') == 'M' ? 'checked' : '' }}><span
                                            class="text-sm">Malo (M)</span></label>
                                </div>
                            </div>
                        </div>
    ...
    <!-- ============================================ -->
    <div id="sec-analisis-infra" class="form-section" x-data="sectionCounter('sec-analisis-infra', 23)" x-init="init()">
        <div class="section-header" @click="toggle()">
            <div class="section-header-left">
                <h2 class="section-title">
    ...
    if (materialRadios.length && materialOtroInput) {
        materialRadios.forEach(radio => {
            radio.addEventListener('change', function() {
                // CORREGIDO: value='7' para "Otro material"
                if (this.value === '7') {
                    materialOtroInput.classList.remove('hidden');
                    materialOtroInput.style.display = 'block'; // Asegurar visibilidad
                    materialOtroInput.focus();
                } else {
                    materialOtroInput.classList.add('hidden');
                    materialOtroInput.style.display = 'none';
        ...
        if (selectedMaterial && selectedMaterial.value === '7') {
            materialOtroInput.classList.remove('hidden');
            materialOtroInput.style.display = 'block';
        } else {
            materialOtroInput.classList.add('hidden');
            materialOtroInput.style.display = 'none';
        }

<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6">
            <div class="bg-gradient-to-r from-teal-50 to-white px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-500 mt-1">Material predominante y estado de conservación del
                    establecimiento
                </p>
            </div>
            <div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6">
        <div class="bg-gradient-to-r from-teal-50 to-white px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">Registre los datos de las edificaciones y sus acabados interiores</p>
        </div>
        <div class="p-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Acabados</th>
                    ...
                    <tbody id="tabla-edificaciones" class="bg-white divide-y divide-gray-200">
                        @if (isset($edificaciones) && $edificaciones->count())
                            @foreach ($edificaciones as $edif)
                                <tr id="fila-{{ $edif->id }}">
                                    ...
                                    <td class="px-4 py-2 text-sm">
                                        <button type="button" onclick="openAcabadosModal({{ $edif->id }})"
                        ...
                        @else
                            <tr id="no-registros">
                                <td colspan="9" class="px-4 py-4 text-center text-gray-500">No hay edificaciones
                                    registradas</td>
                            </tr>
                        @endif
                    </tbody>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6">
        <div class="bg-gradient-to-r from-teal-50 to-white px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">Evaluación técnica del estado de la infraestructura</p>
        </div>
        <div class="p-6 space-y-8">
            ...
            <div class="border rounded-lg p-4 bg-gray-50">
                <h4 class="text-md font-semibold text-gray-800 mb-4 border-l-4 border-teal-600 pl-3">3.3.1 Datos del
                    Edificio y/o Pabellones y/o UPSS a ser evaluados</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Número de Pisos Superiores</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Ubicación del EE.SS.</label>
                        <div class="flex gap-6">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="ubicacion" value="1"
                                    {{ ($infraestructura->ubicacion ?? '') == '1' ? 'checked' : '' }}>
                                <span>Plano</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="ubicacion" value="2"
                                    {{ ($infraestructura->ubicacion ?? '') == '2' ? 'checked' : '' }}>
                                <span>Pendiente</span>
                            </label>
                        </div>
                    </div>
                    <div class="md:col-span-3">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="1" {{ ($infraestructura->material ?? '') == '1' ? 'checked' : '' }}>
                                Ladrillo</label>
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="2" {{ ($infraestructura->material ?? '') == '2' ? 'checked' : '' }}>
                                Madera</label>
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="3" {{ ($infraestructura->material ?? '') == '3' ? 'checked' : '' }}>
                                Metal</label>
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="4" {{ ($infraestructura->material ?? '') == '4' ? 'checked' : '' }}>
                                Drywall</label>
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="5" {{ ($infraestructura->material ?? '') == '5' ? 'checked' : '' }}>
                                Adobe</label>
                            <label class="flex items-center gap-2"><input type="radio" name="material"
                                    value="6" {{ ($infraestructura->material ?? '') == '6' ? 'checked' : '' }}>
                                Caña</label>
                            <label class="flex items-center gap-2 col-span-2"><input type="radio" name="material"
                                    value="7" {{ ($infraestructura->material ?? '') == '7' ? 'checked' : '' }}>
                                Otro material</label>
                        </div>
            ...
            <!-- ============================================ -->
            <div class="border rounded-lg p-4 bg-gray-50">
                <h4 class="text-md font-semibold text-gray-800 mb-4 border-l-4 border-teal-600 pl-3">3.3.2 Evaluación
                    del Estado de la Infraestructura</h4>

                <!-- A. Daños por Inundación -->
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">A. Daños a la infraestructura por Inundación</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="infraestructura_valor_a" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                ...
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">B. Daños a la infraestructura (Movimiento en masa,
                        deslizamiento, Huayco, etc)</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex gap-4 items-center">
                            <span class="text-sm text-gray-600 w-32">¿Presenta daños?</span>
                            <label class="flex items-center gap-2"><input type="radio"
                ...
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">C. Daños a elementos estructurales - Vigas</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex gap-4 items-center">
                            <span class="text-sm text-gray-600 w-32">¿Presenta daños?</span>
                            <label class="flex items-center gap-2"><input type="radio"
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_c" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                ...
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">D. Daños a elementos estructurales - Columnas</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex gap-4 items-center">
                            <span class="text-sm text-gray-600 w-32">¿Presenta daños?</span>
                            <label class="flex items-center gap-2"><input type="radio"
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_d" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                ...
                                <option value="7"
                                    ...
                                    7. Desgaste de columna, por lluvia acida
                                </option>
                                <option value="8"
                ...
                <!-- E. Techos -->
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">E. Techos (aligerado, cobertura liviana u otros)</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex gap-4 items-center">
                            <span class="text-sm text-gray-600 w-32">¿Presenta daños?</span>
                            <label class="flex items-center gap-2"><input type="radio"
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_e" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_f" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_g" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_g ?? '') == '1' ? 'selected' : '' }}>
                                    1. Piso y vereda mojado
                                </option>
                                <option value="2"
                                    {{ ($infraestructura->infraestructura_valor_g ?? '') == '2' ? 'selected' : '' }}>
                                    2. Desprendimiento de cerámico de piso
                                </option>
                                <option value="3"
                                    {{ ($infraestructura->infraestructura_valor_g ?? '') == '3' ? 'selected' : '' }}>
                                    3. Erosión de piso de cemento
                                </option>
                                <option value="4"
                                    {{ ($infraestructura->infraestructura_valor_g ?? '') == '4' ? 'selected' : '' }}>
                                    4. Desprendimiento de contrapiso
                                </option>
                                <option value="5"
                ...
                <div class="mb-6 pb-4 border-b">
                    <h5 class="font-semibold text-gray-700 mb-3">H. Sistema de drenaje pluvial (Canaletas de techo,
                        montantes de bajas, etc)</h5>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex gap-4 items-center">
                            <span class="text-sm text-gray-600 w-32">¿Presenta daños?</span>
                            <label class="flex items-center gap-2"><input type="radio"
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_h" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_h ?? '') == '1' ? 'selected' : '' }}>
                                    1. Filtración de canaleta de techo
                                </option>
                                <option value="2"
                                    {{ ($infraestructura->infraestructura_valor_h ?? '') == '2' ? 'selected' : '' }}>
                                    2. Rotura de canaleta de techo
                                </option>
                                <option value="3"
                                    {{ ($infraestructura->infraestructura_valor_h ?? '') == '3' ? 'selected' : '' }}>
                                    3. Desprendimiento de canaleta
                                </option>
                                <option value="4"
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_i" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_i ?? '') == '1' ? 'selected' : '' }}>
                                    1. Puerta y ventana de madera mojada
                                </option>
                                <option value="2"
                                    {{ ($infraestructura->infraestructura_valor_i ?? '') == '2' ? 'selected' : '' }}>
                                    2. Puerta y ventana de metal oxidada
                                </option>
                                <option value="3"
                                    {{ ($infraestructura->infraestructura_valor_i ?? '') == '3' ? 'selected' : '' }}>
                                    3. Ceraduras y accesorios en mal estado
                                </option>
                                <option value="4"
                                    {{ ($infraestructura->infraestructura_valor_i ?? '') == '4' ? 'selected' : '' }}>
                                    4. Desprendimiento de marco de puerta
                                </option>
                                <option value="5"
                                    {{ ($infraestructura->infraestructura_valor_i ?? '') == '5' ? 'selected' : '' }}>
                                    5. Desprendimiento de puerta
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_j" class="w-full rounded-lg border-gray-300 text-sm"
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_k" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_k ?? '') == '1' ? 'selected' : '' }}>
                                    1. Inundación de cisterna y otros
                                </option>
                                <option value="2"
                                    {{ ($infraestructura->infraestructura_valor_k ?? '') == '2' ? 'selected' : '' }}>
                                    2. Daño de cajas, valvulas, ubicadas en superficie, lodo
                                </option>
                                <option value="3"
                                    {{ ($infraestructura->infraestructura_valor_k ?? '') == '3' ? 'selected' : '' }}>
                                    3. Exposición de tuberías
                                </option>
                                <option value="4"
                                    {{ ($infraestructura->infraestructura_valor_k ?? '') == '4' ? 'selected' : '' }}>
                                    4. Rajadura de tuberías, fuga de desague
                                </option>
                                <option value="5"
                                    {{ ($infraestructura->infraestructura_valor_k ?? '') == '5' ? 'selected' : '' }}>
                                    5. Desaparece tubería por fuerza de lodo
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_l" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_l ?? '') == '1' ? 'selected' : '' }}>
                                    1. Inundación de cajas y buzones
                                </option>
                                <option value="2"
                ...
                <div class="mb-6 pb-4 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_m" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_m ?? '') == '1' ? 'selected' : '' }}>
                                    1. Daño de cajas, valvulas, ubicadas en superficie, lodo
                                </option>
                                <option value="2"
                                    {{ ($infraestructura->infraestructura_valor_m ?? '') == '2' ? 'selected' : '' }}>
                                    2. Exposición de tuberías
                                </option>
                                <option value="3"
                                    {{ ($infraestructura->infraestructura_valor_m ?? '') == '3' ? 'selected' : '' }}>
                                    3. Rajadura de tuberías, fuga de desague
                                </option>
                                <option value="4"
                                    {{ ($infraestructura->infraestructura_valor_m ?? '') == '4' ? 'selected' : '' }}>
                                    4. Desaparece tubería por fuerza de lodo
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="mb-6 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Valoración:</label>
                            <select name="infraestructura_valor_n" class="w-full rounded-lg border-gray-300 text-sm"
                                style="display: none;">
                                <option value="">Seleccione</option>
                                <option value="1"
                                    {{ ($infraestructura->infraestructura_valor_n ?? '') == '1' ? 'selected' : '' }}>
                                    1. Luminarias y tomacorrientes mojados
                                </option>
                                <option value="2"
                                ...
                                <option value="4"
                                    ...
                                    4. Daño a ductos subterraneos
                                </option>
                                <option value="5"
                                    {{ ($infraestructura->infraestructura_valor_n ?? '') == '5' ? 'selected' : '' }}>
                                    5. Perdida total de energía
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="mt-4 pt-4 border-t">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Indicar otro tipo de daño:</label>
            ...
            <!-- ============================================ -->
            <div class="border rounded-lg p-4 bg-gray-50">
                <h4 class="text-md font-semibold text-gray-800 mb-4 border-l-4 border-teal-600 pl-3">3.3.3 Estado del
                    Entorno / Cerramiento Perimetral</h4>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Estado de muro de contención - Usar números -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Estado de muro de
                            contención</label>
                        <div class="flex flex-wrap gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_contencion" value="1"
                                    {{ ($infraestructura->estado_contencion ?? '') == 1 ? 'checked' : '' }}> Bueno
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_contencion" value="2"
                                    {{ ($infraestructura->estado_contencion ?? '') == 2 ? 'checked' : '' }}> Regular
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_contencion" value="3"
                                    {{ ($infraestructura->estado_contencion ?? '') == 3 ? 'checked' : '' }}> Malo
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_contencion" value="0"
                                    {{ ($infraestructura->estado_contencion ?? '') == 0 ? 'checked' : '' }}> No cuenta
                            </label>
                        </div>
                    </div>

                    <!-- Estado de Taludes - Usar números -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Estado de Taludes</label>
                        <div class="flex flex-wrap gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_taludes" value="1"
                                    {{ ($infraestructura->estado_taludes ?? '') == 1 ? 'checked' : '' }}> Bueno
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_taludes" value="2"
                                    {{ ($infraestructura->estado_taludes ?? '') == 2 ? 'checked' : '' }}> Regular
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="estado_taludes" value="3"
                                    {{ ($infraestructura->estado_taludes ?? '') == 3 ? 'checked' : '' }}> Malo
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t pt-4 mt-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- ¿Cuenta con cerco perimetral? -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">¿Cuenta con cerco
                                perimetral?</label>
                            <div class="flex gap-4">
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_erco_perim" value="SI"
                                        class="cp-tiene-cerco"
                                        {{ ($infraestructura->cp_erco_perim ?? '') == 'SI' ? 'checked' : '' }}> SI
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_erco_perim" value="NO"
                                        class="cp-tiene-cerco"
                                        {{ ($infraestructura->cp_erco_perim ?? '') == 'NO' ? 'checked' : '' }}> NO
                                </label>
                            </div>
                        </div>

                        <!-- Material - Usar códigos de 2 caracteres -->
                            ...
                            <div class="flex flex-wrap gap-4">
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_material" value="CO"
                                        ...
                                        {{ ($infraestructura->cp_material ?? '') == 'CO' ? 'checked' : '' }}> Concreto
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_material" value="LA"
                                        class="cp-material-radio"
                                        {{ ($infraestructura->cp_material ?? '') == 'LA' ? 'checked' : '' }}> Ladrillo
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_material" value="FI"
                                        class="cp-material-radio"
                                        {{ ($infraestructura->cp_material ?? '') == 'FI' ? 'checked' : '' }}> Fierro
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_material" value="MI"
                                        class="cp-material-radio"
                                        {{ ($infraestructura->cp_material ?? '') == 'MI' ? 'checked' : '' }}> Mixto
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_material" value="OT"
                                        class="cp-material-radio"
                                        {{ ($infraestructura->cp_material ?? '') == 'OT' ? 'checked' : '' }}> Otro
                                </label>
                            </div>
                        ...
                        <!-- Estado - Usar códigos de 2 caracteres -->
                        <div class="cp-estado-group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Estado</label>
                            <div class="flex gap-4">
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_estado" value="BU"
                                        {{ ($infraestructura->cp_estado ?? '') == 'BU' ? 'checked' : '' }}> Bueno
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_estado" value="RE"
                                        {{ ($infraestructura->cp_estado ?? '') == 'RE' ? 'checked' : '' }}> Regular
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="cp_estado" value="MA"
                                        {{ ($infraestructura->cp_estado ?? '') == 'MA' ? 'checked' : '' }}> Malo
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-6">
        <div class="bg-gradient-to-r from-amber-50 to-white px-6 py-4 border-b border-gray-200">

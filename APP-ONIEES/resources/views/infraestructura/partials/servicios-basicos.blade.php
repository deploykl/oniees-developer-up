...
<div id="sec-agua" class="form-section" x-data="sectionCounter('sec-agua', 8)" x-init="init()">
 ...
 <!-- ============================================ -->
 <div id="sec-desague" class="form-section" x-data="sectionCounter('sec-desague', 5)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-toilet text-green-500"></i> 2. Desagüe / Alcantarillado
                 <span class="section-badge">Servicio básico</span>
         ...
         <div class="form-grid">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                 <div>
                     ...
                     <select name="se_desague" id="se_desague" class="w-full rounded-lg border-gray-300">
                         ...
                         <option value="L"
                             ...
                             tratamiento)</option>
                         <option value="PN"
                             {{ old('se_desague', $format_ii->se_desague ?? '') == 'PN' ? 'selected' : '' }}>Pozo ciego
                             o negro</option>
                         <option value="OTR"
                 ...
                 <div id="se_desague_otro_div"
                     ...
                     <label class="block text-sm font-medium text-gray-700 mb-2">Especifique otro tipo de
                         servicio:</label>
             ...
             <!-- ¿Se encuentra operativo? y Estado de conservación -->
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                 <div>
 ...
 <!-- ELECTRICIDAD -->
 <!-- ============================================ -->
 <div id="sec-electricidad" class="form-section" x-data="sectionCounter('sec-electricidad', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-bolt text-yellow-500"></i> 3. Electricidad
                 <span class="section-badge">Servicio básico</span>
                 <i class="fas accordion-icon" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
             </h2>
 ...
 <!-- TELEFONÍA FIJA -->
 <!-- ============================================ -->
 <div id="sec-telefonia" class="form-section" x-data="sectionCounter('sec-telefonia', 7)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-phone text-purple-500"></i> 4. Telefonía Fija
                 <span class="section-badge">Servicio básico</span>
                 <i class="fas accordion-icon" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
             </h2>
 ...
 <!-- INTERNET -->
 <!-- ============================================ -->
 <div id="sec-internet" class="form-section" x-data="sectionCounter('sec-internet', 15)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-wifi text-indigo-500"></i> 5. Internet
                 <span class="section-badge">Servicio básico</span>
                 <i class="fas accordion-icon" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
             </h2>
         ...
         <div class="form-grid">
             ...
             <div id="se_internet_option_div"
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                     ...
                     <div>
                         <label class="block text-sm font-medium text-gray-700 mb-2">RUC del proveedor:</label>
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                     <div>
                         ...
                         <div class="flex gap-6">
                             <label class="flex items-center gap-2">
                                 <input type="radio" name="internet_conexion" value="SI"
                                     id="internet_conexion_si"
                                     class="rounded-full border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                     {{ old('internet_conexion', $format_ii->internet ?? '') == 'SI' ? 'checked' : '' }}>
                                 <span>SI</span>
                             </label>
                             <label class="flex items-center gap-2">
                                 <input type="radio" name="internet_conexion" value="NO"
                                     id="internet_conexion_no"
                                     class="rounded-full border-gray-300 text-indigo-600 focus:ring-indigo-500"
                     ...
                     <div>
                         ...
                         <div class="flex items-center gap-2">
                             <input type="number" name="internet_porcentaje"
                                 ...
                                 class="w-32 rounded-lg border-gray-300" min="0" max="100"
                                 step="1">
                             <span>% (0-100)</span>
                         </div>
                     </div>
 ...
 <!-- TELEVISIÓN -->
 <!-- ============================================ -->
 <div id="sec-television" class="form-section" x-data="sectionCounter('sec-television', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-tv text-red-500"></i> 6. Televisión
     ...
     <div class="section-content" :class="open ? '' : 'hidden'">
         <div class="form-grid">
             ...
             <!-- ¿Las salas de espera disponen de televisores? -->
             <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                 <div>
                     <label class="block text-sm font-medium text-gray-700 mb-2">
 ...
 <!-- RED MÓVIL -->
 <!-- ============================================ -->
 <div id="sec-red-movil" class="form-section" x-data="sectionCounter('sec-red-movil', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-signal text-blue-500"></i> 7. Red Móvil
     ...
     <div class="section-content" :class="open ? '' : 'hidden'">
         <div class="form-grid">
             ...
             <!-- Modo de uso (visible solo si tiene red móvil = SI) -->
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                     <div>
                         ...
                         <input type="text" name="se_red_proveedor"
                             ...
                             placeholder="Ej: Claro, Movistar, Entel, Bitel">
                     </div>
                     <div>
                         <label class="block text-sm font-medium text-gray-700 mb-2">RUC del proveedor:</label>
 ...
 <!-- GAS NATURAL O GLP -->
 <!-- ============================================ -->
 <div id="sec-gas" class="form-section" x-data="sectionCounter('sec-gas', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-fire text-orange-500"></i> 8. Gas Natural o GLP
     ...
     <div class="section-content" :class="open ? '' : 'hidden'">
         <div class="form-grid">
             <!-- Cuenta con servicio de gas natural o GLP -->
             <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                 <div>
                     <label class="block text-sm font-medium text-gray-700 mb-2">
             ...
             <!-- Modo de uso (visible solo si tiene gas = SI) -->
 ...
 <!-- RESIDUOS SÓLIDOS -->
 <!-- ============================================ -->
 <div id="sec-residuos-solidos" class="form-section" x-data="sectionCounter('sec-residuos-solidos', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-trash-alt text-green-500"></i> 9. Eliminación de Residuos Sólidos
     ...
     <div class="section-content" :class="open ? '' : 'hidden'">
         <div class="form-grid">
             <!-- ¿Cuenta con servicio de eliminación de residuos sólidos? -->
             <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                 <div>
                     <label class="block text-sm font-medium text-gray-700 mb-2">
             ...
             <!-- Modo de uso (visible solo si tiene residuos = SI) -->
 ...
 <!-- ============================================ -->
 <div id="sec-residuos-hospitalarios" class="form-section" x-data="sectionCounter('sec-residuos-hospitalarios', 8)" x-init="init()">
     <div class="section-header" @click="toggle()">
         <div class="section-header-left">
             <h2 class="section-title">
                 <i class="fas fa-biohazard text-red-500"></i> 10. Eliminación de Residuos Hospitalarios
     ...
     <div class="section-content" :class="open ? '' : 'hidden'">
         <div class="form-grid">
             <!-- ¿Cuenta con servicio de eliminación de residuos hospitalarios? -->
             <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                 <div>
                     <label class="block text-sm font-medium text-gray-700 mb-2">
                         ¿Cuenta con servicio de eliminación de residuos hospitalarios? <span
                             class="text-red-500">*</span>
                     </label>
                     <div class="flex gap-6">
                         <label class="flex items-center gap-2">
             ...
             <!-- Modo de uso (visible solo si tiene residuos hospitalarios = SI) -->
 ...
 <div class="mb-8 border-b border-gray-200 pb-6">
     ...
     <div id="sec-personal-salud" class="form-section" x-data="sectionCounter('sec-personal-salud', 4)" x-init="init()">
         <div class="section-header" @click="toggle()">
             <div class="section-header-left">
                 <h2 class="section-title">
                     <i class="fas fa-user-md text-teal-500"></i> 11.1 Personal de Salud
         ...
         <div class="section-content" :class="open ? '' : 'hidden'">
             <div class="form-grid">
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                     ...
                     <div id="sc_personal_operativo_div"
     ...
     <div id="sec-personal-externo" class="form-section" x-data="sectionCounter('sec-personal-externo', 4)" x-init="init()">
         <div class="section-header" @click="toggle()">
             <div class="section-header-left">
                 <h2 class="section-title">
                     <i class="fas fa-users text-blue-500"></i> 11.2 Personal Externo / Paciente
                     <span class="section-badge">Servicios colectivos</span>
                     <i class="fas accordion-icon" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                 </h2>
     ...
     <!-- ============================================ -->
     <div id="sec-personal-discapacitado" class="form-section" x-data="sectionCounter('sec-personal-discapacitado', 4)"
         x-init="init()">
         <div class="section-header" @click="toggle()">
             <div class="section-header-left">
                 <h2 class="section-title">
                     <i class="fas fa-wheelchair text-purple-500"></i> 11.3 Personal Discapacitado
                     <span class="section-badge">Servicios colectivos</span>
                     <i class="fas accordion-icon" :class="open ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                 </h2>
         ...
         <div class="section-content" :class="open ? '' : 'hidden'">
             <div class="form-grid">
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                     ...
                     <div id="sc_vestidores_operativo_div"
                         style="display: {{ old('sc_vestidores', $format_ii->sc_vestidores ?? '') == 'SI' ? 'block' : 'none' }};">
                         <label class="block text-sm font-medium text-gray-700 mb-2">
                             ¿Se encuentra operativo? <span class="text-red-500">*</span>
                         </label>
                         <div class="flex gap-6">
                     ...
                     <div id="sc_vestidores_estado_div"
                         style="display: {{ old('sc_vestidores', $format_ii->sc_vestidores ?? '') == 'SI' ? 'block' : 'none' }};">
                         <label class="block text-sm font-medium text-gray-700 mb-2">
                 ...
                 <div id="sc_vestidores_option_div"
                     style="display: {{ old('sc_vestidores', $format_ii->sc_vestidores ?? '') == 'SI' ? 'block' : 'none' }};">
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                         <div>
                             <label class="block text-sm font-medium text-gray-700 mb-2">

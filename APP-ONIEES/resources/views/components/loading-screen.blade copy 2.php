@props(['show' => false, 'duration' => 5000, 'theme' => 'dark'])
        ...
        <div class="relative z-20 text-center space-y-8 transition-all duration-500 max-w-md w-full mx-6"
            ...
            <div class="mt-6 text-left font-mono text-xs space-y-1.5 p-4 rounded-lg border"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-blue-400">Cargando módulos...</span>
                ...
                <div class="flex items-center gap-2 transition-opacity duration-300"
                     :class="progress > 25 ? 'opacity-100' : 'opacity-0'">
                    <span class="text-green-500">✓</span>
                    <span class="text-slate-400">Conexión segura establecida</span>
                </div>
                <div class="flex items-center gap-2 transition-opacity duration-300"
                     :class="progress > 50 ? 'opacity-100' : 'opacity-0'">
                    <span class="text-green-500">✓</span>
                    <span class="text-slate-400">Validación de credenciales</span>
                </div>
                <div class="flex items-center gap-2 transition-opacity duration-300"
                     :class="progress > 75 ? 'opacity-100' : 'opacity-0'">
                    <span class="text-green-500">✓</span>
                    <span class="text-slate-400">Precarga de recursos</span>
                </div>
            </div>

            <!-- Footer con líneas de código -->
            <div class="pt-4 text-[10px] font-mono space-y-1"
                 :class="theme === 'dark' ? 'text-slate-600' : 'text-slate-300'">
                <div class="flex justify-center gap-2">
                    <span>──</span>
                    <span>SECURE v3.2.1</span>
                    <span>──</span>
                </div>

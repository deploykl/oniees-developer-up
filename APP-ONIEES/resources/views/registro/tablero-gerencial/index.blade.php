                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" maxlength="200" id="nombre_eess"
                                            disabled>
                                ...
                                <div class="card-body">
                                    <div class="row" style="font-size: 10px;font-weight: 600;">
                                        <div class="col-sm-12" style="cursor:pointer;"
                                            onclick="ListadoRecursos('grupoetareo', 'Grupo Etario', 1)">1. Grupo Etario
                                        </div>
                                        <div class="col-sm-12" style="cursor:pointer;"
                                        ...
                                        <div class="col-sm-12" style="cursor:pointer;"
                                            onclick="ListadoRecursos('cargo_estructural', 'Cargo Estructural',2)">5.
                                            Cargo Estructural</div>
                                        <div class="col-sm-12" style="cursor:pointer;"
                                            onclick="ListadoRecursos('cargo_a', '>Cargo A',2)">6. Cargo A</div>
                                        <div class="col-sm-12" style="cursor:pointer;"
                                            onclick="ListadoRecursos('grupofinal2', 'Grupo Final 2', 2)">7. Grupo Final
                                            2</div>
                                        <div class="col-sm-12" style="cursor:pointer;"
    ...
    <script>
        ...
        function ExportarReporteRecursosHumanos() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    debugger;
                    var url = "/admin/tabla-general-personal-tipo-export/" + nombre + "/" + result
                    .where; // ← CAMBIADO

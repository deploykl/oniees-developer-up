<x-appguest-layout>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" min="1" max="99999999" maxlength="8"
                                                class="form-control" name="codigo_ogei" value="" id="codigo_ogei"
                                                placeholder=""
                                    ...
                                    <div class="col-md-9">
                                        <div class="mb-1">
                                            <label for="nombre_eess" class="form-label">Nombre del
                                                Establecimiento</label>
                                            <input type="text" class="form-control form-control-sm" maxlength="200"
                                                id="nombre_eess" disabled>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-control form-control-sm" id="idregion">
                                                <option value="0">TODOS</option>
                                                @foreach ($regiones as $region)
                                                    <option value="{{ $region->idregion }}" <?php echo $region->idregion == $idregion ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-control js-example-basic-single" name="codigo_margesi"
                                                id="codigo_margesi">
                                                <option value="">Seleccionar</option>
                                                @if ($codigo_margesi != '')
                                                    <option value="{{ $codigo_margesi }}" selected>{{ $codigo_margesi }}
                                                    </option>
                                                @endif
                                            </select>
                                            <div class="invalid-feedback">Digite la Provincia</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-control js-example-basic-single" name="nombre_item"
                                                id="nombre_item">
                                                <option value="">Seleccionar</option>
                                                @if ($nombre_item != '')
                                                    <option value="{{ $nombre_item }}" selected>{{ $nombre_item }}
                                                    </option>
                                                @endif
                                            </select>
                ...
                <div class="row">
                        ...
                        <div class="row p-2">
                            <div class="col-md-12 d-grid align-content-between">
                                ...
                                <div class="grafico-registros" style="display:block">
                                    <div id="piechart_3d"
                                        style="width: 100%;max-height: 400px;margin: auto;padding: 5px;"></div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-text">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-2" style="font-size: 10px;font-weight: 600;">
                                                    <span class="badge rounded-pill siga-desc-bueno"
                                                        style="background: #198754;color:#ffffff">47307</span>
                                                </div>
                                                <div class="col-6">
                                                    <div class="progress mb-1">
                                                        <div style="background-color: rgb(25, 135, 84); color: rgb(255, 255, 255); width: 65%; font-size: 10px;"
                                                            class="progress-bar progress-bar-striped progress-bar-animated siga-desc-porc-bueno"
                                                ...
                                                <div class="col-2" style="font-size: 10px;font-weight: 600;">
                                                    <span class="badge rounded-pill siga-desc-regular mr-2"
                                                        style="background: #ffd100;color:#000000">37386</span>
                                                </div>
                                                <div class="col-6">
                                                    <div class="progress mb-1">
                                                        <div style="background-color: rgb(255, 209, 0); color: rgb(0, 0, 0); width: 49%; font-size: 10px;"
                                                            class="progress-bar progress-bar-striped progress-bar-animated siga-desc-porc-regular"
                                                            role="progressbar" aria-valuenow="100" aria-valuemin="0"
                                                            aria-valuemax="100">34%</div>
                                                    </div>
                                                </div>
                                                <div class="col-4" style="font-size: 10px;font-weight: 600;">
                                                    3. MALO
                                                ...
                                                <div class="col-2" style="font-size: 10px;font-weight: 600;">
                                                    <span class="badge rounded-pill siga-desc-malo mr-2"
                                                        style="background: rgb(236, 170, 0);color:#ffffff">14257</span>
                                                </div>
                                                <div class="col-6">
                                                    <div class="progress mb-1">
                                                        <div style="background-color: rgb(236, 170, 0); color: rgb(255, 255, 255); width: 28%; font-size: 10px;"
                                                            class="progress-bar progress-bar-striped progress-bar-animated siga-desc-porc-malo"
                                                            role="progressbar" aria-valuenow="100" aria-valuemin="0"
                                                            aria-valuemax="100">13%</div>
                                                    </div>
                                                </div>
                                                <div class="col-4" style="font-size: 10px;font-weight: 600;">
                                                    4. MUY MALO
                                                ...
                                                <div class="col-2" style="font-size: 10px;font-weight: 600;">
                                                    <span class="badge rounded-pill siga-desc-muy-malo mr-2"
                                                        style="background: #dc3545;color:#ffffff">3693</span>
                                                </div>
                                                <div class="col-6">
                                                    <div class="progress">
                                                        <div style="background-color: rgb(220, 53, 69); color: rgb(255, 255, 255); width: 18%; font-size: 10px;"
                                                            class="progress-bar progress-bar-striped progress-bar-animated siga-desc-porc-muy-malo"
                                                            role="progressbar" aria-valuenow="100" aria-valuemin="0"
                                                            aria-valuemax="100">3%</div>
                                                    </div>
                                                </div>
                                                <button type="button" onclick="ListadoEquipos()"
                                                    style="font-size: 13px;" class="fw-bold mt-1">
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <ol class="p-2 list-group list-group-numbered" style="font-size: 11px;">
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-start pt-1 pb-1">
                                            <div class="ms-2 me-auto">
                                                <div class="fw-bold">ACTIVO</div>
                                            </div>
                                            <span class="badge rounded-pill" id="siga-desc-estado-activo"
                                                style="background: #198754;color:#ffffff">0</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-start pt-1 pb-1">
                                            <div class="ms-2 me-auto">
                                            ...
                                            <span class="badge rounded-pill" id="siga-desc-estado-baja"
                                                style="background: #ffd100;color:#000000">0</span>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4" style="display:none">
                        <div class="row p-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row" style="font-size: 10px;font-weight: 600;">
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('grupoetareo', 'Grupo Etario', 1)">1. Grupo
                                                Etario</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('regimen_laboral', 'R&eacute;gimen Laboral', 2)">
                                                2. R&eacute;gimen Laboral</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('condicion_laboral', 'Condici&oacute;n Laboral',2)">
                                                3. Condici&oacute;n Laboral</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('condicion_laboral_final', 'Condici&oacute;n Laboral Final',2)">
                                                4. Condici&oacute;n Laboral Final</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('cargo_estructural', 'Cargo Estructural',2)">
                                                5. Cargo Estructural</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('cargo_a', '>Cargo A',2)">6. Cargo A</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('grupofinal2', 'Grupo Final 2', 2)">7. Grupo
                                                Final 2</div>
                                            <div class="col-sm-12" style="cursor:pointer;"
                                                onclick="ListadoRecursos('profesion', 'Profesional',2)">8. Profesional
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="board" id="board-rrhh"
                                    style="font-size: 10px;font-weight: 500;display:block;">
                                    <div class="sub_board">
                                        <div class="cont_board" style="position: relative;">
                                            <div class="graf_board" id="barra-recursos-humanos">
                                            </div>
                                            <div id="titulo-recursos-humanos"
                                                style="display: flex;justify-content: space-around;width: 100%;position: absolute;bottom: -40px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="staticBackdropI" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropILabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header pt-2 pb-2 bg-info">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        style="font-size: 10px;background-color: honeydew;"></button>
                </div>
                ...
                <div class="modal-footer pt-2 pb-2 d-flex justify-content-between">
                    ...
                    <div class="btn-group" role="group">
                        <button class="btn btn-success" style="font-size:13px"
                            onclick="ExportarReporteRecursosHumanos()">
                            Exportar Reporte <i class="fas fa-file-excel"></i>
                        </button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            style="font-size: 13px;">CERRAR</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-hover mb-0" style="font-size:12px">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-truncate" style="width: 65px;">Total(R + M + MM)
                                    </th>
                                    <th scope="col" class="text-truncate" style="width: 80px;">Total General(B +
                                        Total)</th>
                                </tr>
                            </thead>
    ...
    <script>
        ...
        $(function() {
            ...
            $('.js-example-basic-single#codigo_margesi').select2({
                ...
                width: '100%',
                ajax: {
                    url: "{{ route('busqueda-codigo-margesi-tablero-guest') }}",
                    method: "POST",
                    data: function({
                        term,
                        page
                    ...
                    processResults: function(response) {
                        debugger;
                        var items = [{
                            text: (!!response.search && response.search != "-" ? (
                                    'Codigo Margesi que contenga: ' + response.search) :
                                "Todos los Codigos"),
                            id: response.search ?? "-"
                        }];
                ...
                ajax: {
                    ...
                    data: function({
                        ...
                        var queryParameters = {
                            ...
                            codigo_margesi: !!$("#codigo_margesi").val() ? $("#codigo_margesi")
                            .val() : "-",
                        }
                        return queryParameters;
                    },
                    processResults: function(response) {
                        ...
                        var items = [{
                            text: (!!response.search && response.search != "-" ? (
                                    'Nombre del Equipo que contenga: ' + response.search) :
                                "Todos los Equipos"),
                            id: response.search ?? "-"
                        }];
                        $.each(response.data, function(index, value) {
        ...
        function drawChartPie(muy_malo, malo, regular, bueno) {
            ...
            var options = {
                title: 'Estado de Conservación de Equipos',
                is3D: true,
                slices: {
                    0: {
                        color: 'red',
        ...
        function onRegion(idregion) {
            try {
                ...
                var total = nivel_i_1 + nivel_i_2 + nivel_i_3 + nivel_i_4 + nivel_ii_1 + nivel_ii_2 + nivel_ii_e +
                    nivel_iii_1 + nivel_iii_2 + nivel_iii_e + nivel_sc;
                $(".siga-conteo-establecimientos").html(total);

                google.charts.setOnLoadCallback(() => drawChartBarras(nivel_i_1, nivel_i_2, nivel_i_3, nivel_i_4,
                    nivel_ii_1, nivel_ii_2, nivel_ii_e, nivel_iii_1, nivel_iii_2, nivel_iii_e, nivel_sc, total));
                ...
                if (codigo_ogei == "0" && nombre_item == "-" && codigo_margesi == "-") {
                    ...
                    google.charts.setOnLoadCallback(() => drawChartPie(desc_muy_malo, desc_malo, desc_regular, (desc_bueno +
                        desc_nuevo)));
                    ...
                    $(".siga-desc-porc-bueno").prop("aria-valuenow", Math.round((desc_bueno + desc_nuevo) / desc_total *
                        100));
                    $(".siga-desc-porc-bueno").css("width", Math.round(((desc_bueno + desc_nuevo) / desc_total * 100) +
                        25) + "%");
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            var desc_bueno = __regiones.flatMap((r) => +(r.bueno)).reduce((prev, curr) => prev +
                                curr, 0);
                            var desc_regular = __regiones.flatMap((r) => +(r.regular)).reduce((prev, curr) =>
                                prev + curr, 0);
                            var desc_malo = __regiones.flatMap((r) => +(r.malo)).reduce((prev, curr) => prev +
                                curr, 0);
                            var desc_muy_malo = __regiones.flatMap((r) => +(r.muy_malo)).reduce((prev, curr) =>
                                prev + curr, 0);
                            var desc_nuevo = __regiones.flatMap((r) => +(r.nuevo)).reduce((prev, curr) => prev +
                                curr, 0);
                            var desc_total = desc_bueno + desc_regular + desc_malo + desc_muy_malo + desc_nuevo;
                            if (desc_total == 0) {
                                $(".grafico-registros-vacio").show();
                            ...
                            google.charts.setOnLoadCallback(() => drawChartPie(desc_muy_malo, desc_malo,
                                desc_regular, (desc_bueno + desc_nuevo)));

                            debugger;
                            $(".siga-desc-bueno").html((desc_bueno + desc_nuevo));
                            $(".siga-desc-bueno-porcentaje").html(Math.round((desc_bueno + desc_nuevo) /
                                desc_total * 100));
                            $(".siga-desc-porc-bueno").html(((desc_bueno + desc_nuevo) / desc_total * 100)
                                .toFixed(2) + "%");
                            $(".siga-desc-porc-bueno").prop("aria-valuenow", Math.round((desc_bueno +
                                desc_nuevo) / desc_total * 100));
                            $(".siga-desc-porc-bueno").css("width", Math.round(((desc_bueno + desc_nuevo) /
                                desc_total * 100) + 25) + "%");

                            $(".siga-desc-regular").html(desc_regular);
                            $(".siga-desc-regular-porcentaje").html(Math.round(desc_regular / desc_total *
                            100));
                            $(".siga-desc-porc-regular").html((desc_regular / desc_total * 100).toFixed(2) +
                                "%");
                            $(".siga-desc-porc-regular").prop("aria-valuenow", Math.round(desc_regular /
                                desc_total * 100));
                            $(".siga-desc-porc-regular").css("width", Math.round((desc_regular / desc_total *
                                100) + 25) + "%");

                            $(".siga-desc-malo").html(desc_malo);
                            $(".siga-desc-malo-porcentaje").html(Math.round(desc_malo / desc_total * 100));
                            $(".siga-desc-porc-malo").html((desc_malo / desc_total * 100).toFixed(2) + "%");
                            $(".siga-desc-porc-malo").prop("aria-valuenow", Math.round(desc_malo / desc_total *
                                100));
                            $(".siga-desc-porc-malo").css("width", Math.round((desc_malo / desc_total * 100) +
                                25) + "%");

                            $(".siga-desc-muy-malo").html(desc_muy_malo);
                            $(".siga-desc-muy-malo-porcentaje").html(Math.round(desc_muy_malo / desc_total *
                                100));
                            $(".siga-desc-porc-muy-malo").html((desc_muy_malo / desc_total * 100).toFixed(2) +
                                "%");
                            $(".siga-desc-porc-muy-malo").prop("aria-valuenow", Math.round(desc_muy_malo /
                                desc_total * 100));
                            $(".siga-desc-porc-muy-malo").css("width", Math.round((desc_muy_malo / desc_total *
                                100) + 25) + "%");

                            debugger;
                            var activo = __regiones.flatMap((r) => +(r.activo)).reduce((prev, curr) => prev +
                                curr, 0);
                            var baja = __regiones.flatMap((r) => +(r.baja)).reduce((prev, curr) => prev + curr,
                                0);
                            $("#siga-desc-estado-activo").html(activo);
                            $("#siga-desc-estado-baja").html(baja);
                        },
                    ...
                    $.each(datos.links, function(index, item) {
                        ...
                        if (item.active) {
                            if (isNaN(item.label) && item.label != "...") {
                                $("#pagination_number").append(
                                    '<span class="sm:hidden relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5">' +
                                    item.label + '</span>');
                            } else {
                                $("#pagination_number").append(
                                    '<span class="hidden sm:flex relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5">' +
                                    item.label + '</span>');
                            }
                        } else {
                            var page_number = item.url != null ? item.url.replace(/[^0-9]/g, '') : "";
                            if (isNaN(item.label) && item.label != "...") {
                                $("#pagination_number").append('<button onclick="ListadoEquipos(' +
                                    "'" + page_number + "'" +
                                    ')" type="button" class="sm:hidden relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">' +
                                    item.label + '</button>');
                            } else {
                                $("#pagination_number").append('<button onclick="ListadoEquipos(' +
                                    "'" + page_number + "'" +
                                    ')" type="button" class="hidden sm:flex relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">' +
                                    item.label + '</button>');
                            }
                        }
                    });
        ...
        function ListadoRecursos(nombre, titulo, tipo) {
            ...
            var url = "{{ route('tabla-general-personal-tipo') }}/" + nombre + "/" + idregion + "/" + codigo_ogei;
            $.ajax({
                type: "GET",
                url: url,
                success: function(result) {
                    ...
                    if (tipo == 2) {
                        ...
                        $.each(result, function(index, item) {
                            ...
                            $("#barra-recursos-humanos").append('<div class="barra">' +
                                '<div class="sub_barra" style="background-color: #4473C5;height: ' +
                                porcentaje + "%" + ';">' +
                                '<div class="tag_g">' + item.cantidad + '</div>' +
                                '<div class="tag_leyenda" style="white-space: nowrap;">' + item
                                .nombre + '</div>' +
                                '</div>' +
                                '</div>');
                        });
        ...
        function ExportarReporte() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    debugger;
                    var url = "{{ route('tabla-general-detalle-export') }}/" + result.where;
        ...
        function ExportarReporteRecursosHumanos() {
            var idregion = $("#idregion").val();
            var codigo_ogei = !!$("#codigo_ogei").val() ? $("#codigo_ogei").val() : "0";
            var nombre = $("#input-tipo-rrhh").val();
            var url = "{{ route('tabla-general-personal-tipo-export') }}/" + nombre + "/" + idregion + "/" + codigo_ogei;

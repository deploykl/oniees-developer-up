<div>
    ...
    @if(isset($pintado->$field_name) && $pintado->$field_name)
        ...
        <div class="mb-2">
            ...
            <a href="{{ asset('storage/' . $pintado->$field_name) }}" download="{{ $field_label }}" class="btn btn-secondary">
                Descargar Imagen
            </a>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <img src="{{ asset('storage/' . $pintado->$field_name) }}" alt="{{ $field_label }}" style="max-width: 100%; height: auto;" class="img-fluid">
                    </div>
